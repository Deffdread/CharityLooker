...
public class LinearProbing2 {
	...
	private String[] keys;
	private String[] vals;
	private LinkedList<String> other;

	public LinearProbing2(int m) {
		this.n = 0;
		this.m = m;
		this.keys = new String[m];
		this.vals = new String[m];
		this.other = new LinkedList<String>();
	}
	...
	private void resize(int capacity) {
		LinearProbing2 temp = new LinearProbing2(capacity);
	...
	public void put(String key, String charity) {
		...
		for (i = hash(key); this.keys[i] != null; i = (i + 1) % m) {
			if (this.keys[i].equals(key) && charity.equals("I1")) {
				other.add(charity);
				return;
			}
		}
	...
	public LinkedList<String> getOther(){
		return other;
	}
